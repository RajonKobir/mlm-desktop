...
if($temp_level == 0){
	...
	$query = PDO_Execute("update tree set `l1`=date('now') where userid='$user_id_stage_level'");
...
if($temp_level == 1){
        if($temp_leftcount >= 2 && $temp_rightcount >= 2){
            $temp_level++;
    $query = PDO_Execute("update tree set `level`='$temp_level' where userid='$user_id_stage_level'");
	$query = PDO_Execute("update tree set `l2`=date('now') where userid='$user_id_stage_level'");
...
if($temp_level == 2){
        if($temp_leftcount >= 4 && $temp_rightcount >= 4){
            $temp_level++;
    $query = PDO_Execute("update tree set `level`='$temp_level' where userid='$user_id_stage_level'");
	$query = PDO_Execute("update tree set `l3`=date('now') where userid='$user_id_stage_level'");
...
$query = PDO_Execute("update tree set `temp_leftcount`='$temp_leftcount' where userid='$user_id_stage_level'");
    $temp_rightcount = 0;
$query = PDO_Execute("update tree set `temp_rightcount`='$temp_rightcount' where userid='$user_id_stage_level'");
$query = PDO_Execute("update tree set `l4`=date('now') where userid='$user_id_stage_level'");
		}
        }
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Join Members</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
